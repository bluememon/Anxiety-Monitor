!function(f) {
    var x, z = f.Chart, s = f.addEvent, A = f.removeEvent, B = HighchartsAdapter.fireEvent, j = f.createElement, p = f.discardElement, u = f.css, l = f.merge, m = f.each, q = f.extend, E = f.splat, F = Math.max, k = document, C = window, G = f.isTouchDevice, H = f.Renderer.prototype.symbols, r = f.getOptions();
    q(r.lang, {
    ...
    q(z.prototype, {
        ...
        getSVG: function(b) {
            var e, c, g, y, h, a = this, d = l(a.options, b);
            ...
            m([ "xAxis", "yAxis" ], function(b) {
                m(a[b], function(a, d) {
                    ...
                    c && (void 0 !== h || void 0 !== g) && c.setExtremes(h, g, !0, !1);
                });
            });
        ...
        print: function() {
            ...
            b.isPrinting || (b.isPrinting = !0, B(b, "beforePrint"), m(f, function(a, b) {
        ...
        contextMenu: function(b, a, e, c, g, f, h) {
            var v, w, p, d = this, l = d.options.navigation, D = l.menuItemStyle, n = d.chartWidth, o = d.chartHeight, k = "cache-" + b, i = d[k], t = F(g, f), r = function(a) {
            ...
            c + f + d.exportMenuHeight > o && "top" !== h.alignOptions.verticalAlign ? a.bottom = o - c - t + "px" : a.top = c + f - t + "px";
            u(i, a);
            d.openMenu = !0;
        },
        addButton: function(b) {
            var h, d, a = this, e = a.renderer, c = l(a.options.navigation.buttonOptions, b), g = c.onclick, k = c.menuItems, m = {
            ...
            if (c.enabled !== !1) {
                var i, n = c.theme, o = n.states, p = o && o.hover, o = o && o.select;
                delete n.states;
                g ? i = function() {
                    g.apply(a, arguments);
                } : k && (i = function() {
                ...
                x += (d.width + c.buttonSpacing) * ("right" === c.align ? -1 : 1);
                a.exportSVGElements.push(d, h);
            }
        },
        destroyExport: function(b) {
            var a, e, b = b.target;
            for (a = 0; a < b.exportSVGElements.length; a++) (e = b.exportSVGElements[a]) && (e.onclick = e.ontouchstart = null, 
            b.exportSVGElements[a] = e.destroy());
            for (a = 0; a < b.exportDivElements.length; a++) e = b.exportDivElements[a], A(e, "mouseleave"), 
            b.exportDivElements[a] = e.onmouseout = e.onmouseover = e.ontouchstart = e.onclick = null, 
            p(e);
        }
    });
    H.menu = function(b, a, e, c) {
        return [ "M", b, a + 2.5, "L", b + e, a + 2.5, "M", b, a + c / 2 + .5, "L", b + e, a + c / 2 + .5, "M", b, a + c - 1.5, "L", b + e, a + c - 1.5 ];
    };
